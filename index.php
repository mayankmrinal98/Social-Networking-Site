...
if ($fname!= "" && $lname!= "" && $login!= "" && $password!= "" && $cpassword==$password && $address!="" && preg_match($pattern,$email) && $cnumber!="" ) {
	...
	if(!$db) {
		die("Unable to select database");
				...
				$query = mysqli_query($link,"INSERT INTO members(UserName, Password, FirstName, LastName, Address, ContactNo, Url, Birthdate, Gender, profImage,curcity)VALUES('$login','$password','$fname','$lname','$address','$cnumber','$email','$bday','$gender','$propic','$address')")or die(mysqli_error($link));  
...
<div class="downleft">
  <div class="picture">
  <img src="bg/a.png" width="500" height="330" />
  </div>
  <div class="field">
